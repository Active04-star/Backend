...
class InnerResponseInfo extends OmitType(User, ["managed_centers", "password", "reservations", "reviews", "payments", "managers_list", "paymentHistory", "subscriptionPayments"]) { }